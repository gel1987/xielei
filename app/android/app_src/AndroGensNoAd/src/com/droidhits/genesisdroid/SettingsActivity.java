...
/**
 * Settings activity. Allows easy access to any/all desired settings and manages
 * to auto save them
 * 
 * @author halsafar
 * 
...
//    customPref.setOnPreferenceClickListener(null);
    ...
    customPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
        try {
          Intent intent = new Intent(SettingsActivity.this, KeyboardConfigActivity.class);
      ...
      checkPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
        public boolean onPreferenceClick(Preference preference) {
          ...
          if (checkValue) {
            ...
            if (!f.exists()) {
              Builder dialog = new AlertDialog.Builder(SettingsActivity.this).setTitle("Game Genie Not Found")
            ...
            if (enableAutosave) {
              Toast.makeText(getApplicationContext(),
                  "Cannot auto load with game genie enabled, will still auto save.", Toast.LENGTH_LONG).show();
            }
    ...
    checkPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
        ...
        if (checkValue) {
          ...
          if (enableGameGenie) {
            Toast.makeText(getApplicationContext(), "Cannot auto load with game genie enabled, will still auto save.",
    ...
    customPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
        ...
        myIntent.putExtra(FileChooser.EXTRA_START_DIR, Preferences.getRomDir(getApplicationContext()));
