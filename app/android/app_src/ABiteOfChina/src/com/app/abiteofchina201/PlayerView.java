...
public class PlayerView implements OnBufferingUpdateListener, OnCompletionListener, MediaPlayer.OnPreparedListener,
    ...
    btnPlay.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        if (PlayerView.STATE == PlayerView.STOP) {
          btnPlay.setImageResource(R.drawable.pause_ico_on);
          playUrl();
        ...
        } else if (PlayerView.STATE == PlayerView.PLAYING) {
          btnPlay.setImageResource(R.drawable.play_ico_on);
          pause();
  ...
  private Bitmap getThumbnail(Context paramContext, long paramLong, Uri paramUri) {
    ...
    try {
      ...
      if (localBitmap1 == null) {
        localBitmap1 = BitmapFactory.decodeResource(paramContext.getResources(), R.drawable.photo_default_img_night);
      }
      return localBitmap1;
