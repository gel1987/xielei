...
public class MainActivity extends Activity {
  ...
  private boolean verifyExternalStorage() {
    ...
    if (!mExternalStorageAvailable || !mExternalStorageWriteable) {
      Builder dialog = new AlertDialog.Builder(this).setTitle(getString(R.string.app_name) + " Error")
  ...
  private void init() {
    if (verifyExternalStorage() && !_init) {
      ...
      // set the paths
      Emulator.setPaths(extStorageDirectory + Preferences.DEFAULT_DIR, extStorageDirectory
          + Preferences.DEFAULT_DIR_ROMS, extStorageDirectory + Preferences.DEFAULT_DIR_STATES, extStorageDirectory
          + Preferences.DEFAULT_DIR_SRAM, extStorageDirectory + Preferences.DEFAULT_DIR_CHEATS);
  ...
  private void initGUIEvent() {
    ...
    tmpButton = (Button) findViewById(R.id.buttonGames);
    tmpButton.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        moreGames();
      }
    });
    tmpButton = (Button) findViewById(R.id.buttonRate);
    tmpButton.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        rating();
      }
  ...
  protected void moreGames() {
    Intent browserIntent = new Intent(Intent.ACTION_VIEW,
        Uri.parse("https://twitter.com/followlxl"));
