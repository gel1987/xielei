...
import com.donate.pay.ShellUtils.CommandResult;
...
public class PackageUtils {
	...
	public static boolean isAppExist(Context context, String appPackage,
		...
		try {
			...
			if (apkVerCode == version) {
				return true;
			} else {
				Toast.makeText(context, "请先删除冲突的版本", Toast.LENGTH_LONG).show();
				uninstallNormal(context, appPackage);
			}
		} catch (NameNotFoundException e) {
		}
		// FileUtil.copyFromAssets(context, "safepay", filePath);
