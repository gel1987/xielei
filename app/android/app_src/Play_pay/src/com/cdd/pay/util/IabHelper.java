...
public class IabHelper {
   ...
   *          base64-encoded public key in your application's page on Google
  ...
  public interface OnIabPurchaseFinishedListener {
     ...
     * successful, then the sku parameter specifies which item was purchased. If
     * the purchase failed, the sku and extraData parameters may or may not be
     * null, depending on how far the purchase process went.
     * 
     * @param result
   ...
   * Play, and the result will be delivered via the activity's
   ...
   * @param extraData
   *          Extra data (developer payload), which will be returned with the
   *          purchase data when the purchase completes. This extra data will be
   *          permanently bound to that purchase and will always be returned
   *          when the purchase is queried.
   */
...
/**
   ...
   * well as information on additional skus, if specified. This method may block
   * or take long to execute. Do not call from a UI thread. For that, use the
   * non-blocking version {@link #refreshInventoryAsync}.
   * 
   * @param querySkuDetails
   *          if true, SKU details (price, description, etc) will be queried as
   ...
   * @param moreSubsSkus
   *          additional SUBSCRIPTIONS skus to query information on, regardless
   *          of ownership. Ignored if null or if querySkuDetails is false.
   * @throws IabException
