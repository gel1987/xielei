...
public class MainActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // enable debug logging (for a production application, you should set this
    // to false).
  ...
  public void onBuyGasButtonClicked(View arg0) {
    ...
    /*
     * TODO: for security, generate your payload here for verification. See the
     * comments on verifyDeveloperPayload() for more info. Since this is a
     * SAMPLE, we just use an empty string, but on a production app you should
  ...
  public void onInfiniteGasButtonClicked(View arg0) {
    ...
    mHelper.launchPurchaseFlow(this, SKU_INFINITE_GAS, IabHelper.ITEM_TYPE_SUBS, RC_REQUEST, mPurchaseFinishedListener,
        payload);
  }
  ...
  boolean verifyDeveloperPayload(Purchase p) {
    ...
    /*
     * TODO: verify that the developer payload of the purchase is correct. It
     * will be the same one that you sent when initiating the purchase.
     * 
  ...
  IabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new IabHelper.OnConsumeFinishedListener() {
    public void onConsumeFinished(Purchase purchase, IabResult result) {
      ...
      if (result.isSuccess()) {
        ...
        // game world's logic, which in our case means filling the gas tank a
        // bit
  ...
  public void updateUi() {
    ...
    ((ImageView) findViewById(R.id.free_or_premium))
        .setImageResource(mIsPremium ? R.drawable.premium : R.drawable.free);

    // "Upgrade" button is only visible if the user is not premium
    findViewById(R.id.upgrade_button).setVisibility(mIsPremium ? View.GONE : View.VISIBLE);

    // "Get infinite gas" button is only visible if the user is not subscribed
    // yet
  ...
  void saveData() {
    ...
    /*
     * WARNING: on a real application, we recommend you save data in a secure
     * way to prevent tampering. For simplicity in this sample, we simply store
     * the data using a SharedPreferences.
     */
